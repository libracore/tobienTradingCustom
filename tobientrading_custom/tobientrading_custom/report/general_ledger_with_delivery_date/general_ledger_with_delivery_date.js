...
//
// Filters are a copy of ERPNext's "General Ledger" report, see
// general_ledger_with_delivery_date.py for the added Delivery Date column.

frappe.query_reports["General Ledger with Delivery Date"] = {
	filters: [
		{
			fieldname: "company",
			label: __("Company"),
...
erpnext.utils.add_dimensions("General Ledger with Delivery Date", 15);
